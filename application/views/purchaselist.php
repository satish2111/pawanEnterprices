					...
					<tbody>
						...
						<tr id="<?php echo htmlentities($row->pur_id); ?>">
							...
							<td>
								...
								echo  anchor("purchase/getdetails/$title/{$row->pur_id}/{$row->FirstName}",' Payment','class="fas fa-rupee-sign btn-xs btn btn-success " aria-hidden="true"')?>
							</td>
							<td>
								<?php
							...
							<td>
								...
								<button onclick="dlefunction(<?php echo $row->pur_id ?>)" class="btn-xs btndelete"><span class="fas fa-trash"> Delete</button>
							</td>
						</tr>
						<?php
