	...
	<div class="row">
		<div class="col-md-4">
			<div class="form-group row align-items-center">
				...
				<div class="col-md-9">
					...
					<input type="text" name="txtbillno" value="<?php echo $result[0][0]->billno;?>" id='billno' placeholder="Billno" class="form-control">
					<input type="hidden" name="txtPurId" value="<?php echo $result[1][0]->Pur_fk_Id;?>" id ='PurId' placeholder="Product Name" class="form-control" required>
				</div>
			</div>
		...
		<div class="col-md-4">
			<div class="form-group row align-items-center">
				...
				<div class="col-md-9">
					...
					<input class="form-control" id="date" value=
					"<?php echo $texdate; ?>" data-format="dd/MM/yyyy" name="date"  type="date" autocomplete="off" required />
				</div>
			</div>
		...
		<div class="col-md-4">
			<div class="form-group row align-items-center">
				...
				<div class="col-md-9">
					<input id="supplername" list="supplername1" placeholder="Select Suppler"  type="text" name="supplername" class="form-control" value="<?php  echo $result[0][0]->FirstName; ?>"  style="text-transform: uppercase;">
					<datalist  id='supplername1' required  name='supplername1'>
						<option data-value='<?php echo $result[0][0]->suppler_id?>' value =<?php echo $result[0][0]->FirstName; ?>>
						</option>
...
$(document).ready(function() {
	...
	//$('#date').val(new Date(date).toISOString().substr(0, 10));
