...
<div class="container">
	<div class="row mt-5">
		<div class="col-md-12">
			...
			<div class="row">
				<div class="col-md-2">
					<a href="<?php echo site_url('insert/InsertSuppler'); ?>" class='mb-5'>
					<button class="btn btn-primary">Add Suppliers</button></a>
				</div>
				<div class="col-md-10">
					...
					<table id="mytable" class="table table-bordred table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<?php
									//for passing row id to controller Read/getdetails
									echo  anchor("Read/getdetails/$title/{$row->suppler_id}",' Edit','class="fas fa-edit btn-xs" aria-hidden="true"')?>
								</td>
								<td>
									<?php
									...
									<button onclick="dlefunction(<?php echo$row->suppler_id?>)" class="btn-xs btndelete"><span class="fas fa-trash"> Delete</button>
								</td>
							</tr>
							<?php
	...
	{
		var id='<?php echo base_url(); ?>index.php/suppler/delete/'+id;
		Swal.fire({
			title: 'Are you sure?',
