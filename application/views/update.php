...
<div class="container">
	...
	<?php } ?>
	<?php echo form_open('Insert/updatedetails/Clients',['name'=>'insertdata','autocomplete'=>'off']);?>
	<?php echo form_hidden('client_id',$row->client_id);?>
	<div class="row">
	...
	<div class="row">
		<div class="col-md-4"><b>Credit days<sup class="star">*</sup></b>
			<?php echo form_input(['name'=>'creditdays','onkeypress'=>'return isNumberKey(event)','class'=>'form-control','maxlength'=>'2','minlength'=>'1','placeholder'=>'Credit days','required'=>'required','value'=>set_value('creditdays',$row->creditdays)]);?>
