        ...
        <div class="col-md-12 ">
            ...
            <div class="row">
                <div class="col-sm-12 text-center" style='color:red;'>
                    <h6 style='margin-right: 6rem;font-weight: 800;letter-spacing: 1px;'>Please Enter Only One TextBox</h6>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-10">
                    <div class="row">
                        <form action="<?php echo base_url(); ?>sale/search" method="get"
                            onsubmit="return ValidationEvent()">
                            <div class=" input-group col-md-3">
                                <input type="text" name="billno" id='billno' class="form-control"
                                    placeholder="Search By Bill No" autocomplete='off' onkeypress='validate(event)' maxlength="7" />
                            </div>
                            <div class=" input-group col-md-3">
                                <input type="text" name="search" id="search" list="search1" class="form-control "
                                    placeholder="Search Client Name" autocomplete='off' require>
                            ...
                            <div class=" input-group col-md-3">
                                <input type="text" name="productname" list='productname1' value="" id='productname'
                                    placeholder="Search Product Name" class="form-control" require>
...
function ValidationEvent() {
    ...
    if (clientname == '' && productname == '' && billno == '') {
        // alert('hi');
        Swal.fire({
            title: 'Error!',
            text: "Please Select Bill No. Or Client Name Or Product Name",
            icon: 'error',
            timer: 2000,
    ...
    (async () => {
        ...
        const {
            ...
            html: '<label for="nameField" class="" style="color:red;float: left;" >Total Bill Amount :- </label>' +
                '<label for="nameField" class="" style="color:green;float: left;" >&nbsp;' + billAmt +
                '</label>' + '<br/><br/>' +
                '<label for="nameField" class="" style="color:red;float: left;" >Total Paid Amount :- </label>' +
                '<label for="nameField" class="" id="lbtPaidAmt" style="color:green;float: left;">&nbsp;' +
                paidAmt + '</label>' + '<br/><br/>' +
                '<label for="nameField" class="" style="color:red;float: left;" >Total Outstanding Amount :- </label>' +
                '<label for="nameField" class="" style="color:green;float: left;" >&nbsp;' +
                outstandingAmt + '</label>' + '<br/><br/>' +
                '<label for="nameField" class="col-sm-12" style="margin-top:0em; padding:0rem;color:green">Now Pay</label>' +
                '<input id="swal-input1" class="swal2-input form-control"  placeholder="' + nowPay +
                '" autocomplete ="off">' +
        ...
        if (formValues) {
            ...
            if (payAmount <= nowPay) {
                var CurrentPaidAmt = (parseFloat(document.getElementById('swal-input1').value) + parseFloat(
                    paidAmt)).toFixed(2);
                ...
                var MsgError = 'The Amount you Enter is Max then Outstanding.  Outstanding Is  ' + nowPay +
                    ' And You are to Pay That ' + payAmount;
                Swal.fire({
                    title: 'Error',
                    text: MsgError,
                    icon: 'error',
